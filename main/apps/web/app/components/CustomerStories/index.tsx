    ...
    <SectionContainer id="customers">
      ...
      <div className="mx-auto mt-5 grid grid-cols-12 gap-5">
        {caseStudyThumbs.map((caseStudy: any, i: number) => (
          <Link href={`${caseStudy.link}`} key={caseStudy.title} className="col-span-12 md:col-span-4">
            <Panel hasActiveOnHover outerClassName="h-full">
              <GlassPanel {...caseStudy} background={false} className="border-none" showIconBg={true} showLink={true}>
