  ...
  return (
    <SectionContainer id="examples" className="xl:pt-32">
      <div className="text-center">
        ...
        <p className="p">Kickstart your next project with templates built by us and our community.</p>
        <div className="flex justify-center gap-2 py-4">
          ...
          <Button asChild type="default" icon={<IconGitHubSolid size="tiny" />} size="small">
            <Link href="https://github.com/supabase/supabase/tree/master/examples">Official GitHub library</Link>
          </Button>
        </div>
      </div>
      <div className="mt-16 grid grid-cols-12 gap-5">
        {Examples.slice(0, 6).map((example, i) => {
          return (
            <div className={`col-span-12 lg:col-span-6 xl:col-span-4 ${i > 2 && `sm:hidden lg:block`}`} key={i}>
