...
function TwitterSocialProof() {
  ...
  const handleShowMore = () => {
    setTweets((prevTweets) => [...prevTweets, ...Tweets.slice(prevTweets.length, prevTweets.length + 10)]);
        ...
        <div className="col-span-12 text-center">
          ...
          <div className="my-8 flex justify-center gap-2">
            <Button asChild size="small" iconRight={<IconMessageCircle size={14} />} type="default">
              <Link href={'https://github.com/supabase/supabase/discussions'} target="_blank" tabIndex={-1}>
                GitHub discussions
              </Link>
            </Button>
