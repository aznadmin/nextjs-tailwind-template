  ...
  const sendTelemetryEvent = async (product: PRODUCT_SHORTNAMES) => {
    switch (product) {
      case PRODUCT_SHORTNAMES.DATABASE:
        return await Telemetry.sendEvent(gaEvents['www_hp_subhero_products_database'], telemetryProps, router);
      case PRODUCT_SHORTNAMES.AUTHENTICATION:
        return await Telemetry.sendEvent(gaEvents['www_hp_subhero_products_auth'], telemetryProps, router);
      case PRODUCT_SHORTNAMES.STORAGE:
        return await Telemetry.sendEvent(gaEvents['www_hp_subhero_products_storage'], telemetryProps, router);
      case PRODUCT_SHORTNAMES.FUNCTIONS:
        return await Telemetry.sendEvent(gaEvents['www_hp_subhero_products_edgeFunctions'], telemetryProps, router);
      case PRODUCT_SHORTNAMES.REALTIME:
        return await Telemetry.sendEvent(gaEvents['www_hp_subhero_products_realtime'], telemetryProps, router);
      case PRODUCT_SHORTNAMES.VECTOR:
        return await Telemetry.sendEvent(gaEvents['www_hp_subhero_products_vector'], telemetryProps, router);
    }
  };
      ...
      <ProductCard
        ...
        subtitle={
          <>
            ...
            <br className="inline-block sm:hidden lg:inline-block" /> securing your data with Row Level Security.
          </>
        }
        image={<AuthVisual />}
      ...
      <ProductCard
        ...
        subtitle={
          <>
            ...
            <br className="inline-block sm:hidden lg:inline-block" /> without deploying or scaling servers.
          </>
        }
      ...
      <ProductCard
        ...
        subtitle={
          <>
            ...
            <br className="inline-block md:hidden 2xl:inline-block" /> with realtime data synchronization.
          </>
        }
      ...
      <ProductCard
        ...
        highlights={
          <ul className="flex flex-col gap-1 text-sm">
            ...
            <li className="flex items-center gap-2">
              <Image src="/images/logos/hugging-face.svg" alt="Hugging Face logo" width="25" height="25" />
