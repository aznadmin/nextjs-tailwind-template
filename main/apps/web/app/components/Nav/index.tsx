      ...
      >
        ...
        >
          <div className="relative flex justify-between h-16 mx-auto lg:container lg:px-16 xl:px-20">
            <div className="flex items-center px-6 lg:px-0 flex-1 sm:items-stretch justify-between">
              <div className="flex items-center">
                <div className="flex items-center flex-shrink-0">
                  ...
                  {!isSpecialAnnouncementPage && !isLaunchWeek11Page && isLaunchWeekPage && !isLaunchWeekXPage && (
                    <Link
                      href="/launch-week"
                      as="/launch-week"
                    ...
                    {menu.primaryNav.map((menuItem) =>
                      menuItem.hasDropdown ? (
                        <NavigationMenuItem className="text-sm font-medium" key={menuItem.title}>
                          ...
                          <NavigationMenuContent className={cn('rounded-xl', menuItem.dropdownContainerClassName)}>
                            {menuItem.dropdown}
                          </NavigationMenuContent>
                        </NavigationMenuItem>
                      ) : (
            ...
            <HamburgerButton toggleFlyOut={() => setOpen(true)} showLaunchWeekNavMode={showLaunchWeekNavMode} />
          </div>
